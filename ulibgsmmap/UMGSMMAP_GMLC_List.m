...
- (UMGSMMAP_GMLC_List *) processAfterDecodeWithContext:(id)context
{
	...
	while(o)
	{
        UMGSMMAP_ISDN_AddressString *e = [[UMGSMMAP_ISDN_AddressString alloc]initWithASN1Object:o context:context];
...
- (id) objectValue
{
    ...
    for(UMGSMMAP_ISDN_AddressString *e in _sequenceEntries)
    {
