...
- (UMGSMMAP_PLMNClientList *) processAfterDecodeWithContext:(id)context
{
	...
	while(o)
	{
        UMGSMMAP_LCSClientInternalID *e = [[UMGSMMAP_LCSClientInternalID alloc]initWithASN1Object:o context:context];
...
- (id) objectValue
{
    ...
    for(UMGSMMAP_LCSClientInternalID *e in _sequenceEntries)
    {
...
- (void)addEntry:(UMGSMMAP_LCSClientInternalID *)e
{
