...
- (UMGSMMAP_GPRSDataList *) processAfterDecodeWithContext:(id)context
{
	...
	while(o)
	{
        UMGSMMAP_PDP_Context *e = [[UMGSMMAP_PDP_Context alloc]initWithASN1Object:o context:context];
...
- (id) objectValue
{
    ...
    for(UMGSMMAP_PDP_Context *e in _sequenceEntries)
    {
...
- (void)addEntry:(UMGSMMAP_PDP_Context *)e
{
