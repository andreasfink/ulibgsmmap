//
//  UMGSMMAP_PDP_ContextInfoList.m
//  ulibgsmmap
//
...
- (UMGSMMAP_PDP_ContextInfoList *) processAfterDecodeWithContext:(id)context
{
	...
	while(o)
	{
        UMGSMMAP_PDP_ContextInfo  *e = [[UMGSMMAP_PDP_ContextInfo alloc]initWithASN1Object:o context:context];
...
- (NSString *) objectName
{
	return @"PDP-ContextInfoList";
}

- (id) objectValue
{
    UMSynchronizedArray *arr = [[UMSynchronizedArray alloc]init];
    for(UMGSMMAP_PDP_ContextInfo *e in _sequenceEntries)
    {
...
- (void)addEntry:(UMGSMMAP_PDP_ContextInfo  *)e
{
