...
- (UMGSMMAP_LSADataList *) processAfterDecodeWithContext:(id)context
{
	...
	while(o)
	{
        UMGSMMAP_LSAData *e = [[UMGSMMAP_LSAData alloc]initWithASN1Object:o context:context];
...
- (id) objectValue
{
    ...
    for(UMGSMMAP_LSAData *e in _sequenceEntries)
    {
...
- (void)addEntry:(UMGSMMAP_LSAData *)e
{
