...
- (UMGSMMAP_Ext_CallBarFeatureList *) processAfterDecodeWithContext:(id)context
{
	...
	while(o)
	{
        UMGSMMAP_Ext_CallBarringFeature  *e = [[UMGSMMAP_Ext_CallBarringFeature alloc]initWithASN1Object:o context:context];
...
- (id) objectValue
{
    ...
    for(UMGSMMAP_Ext_CallBarringFeature *e in _sequenceEntries)
    {
