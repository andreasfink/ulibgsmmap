...
@implementation UMGSMMAP_D_CSI


@synthesize	operationName;
@synthesize	dp_AnalysedInfoCriteriaList;
...
- (void) processBeforeEncode
{
	...
	if(dp_AnalysedInfoCriteriaList)
	{
		dp_AnalysedInfoCriteriaList.asn1_tag.tagNumber = 0;
		dp_AnalysedInfoCriteriaList.asn1_tag.tagClass = UMASN1Class_ContextSpecific;
		[_asn1_list addObject:dp_AnalysedInfoCriteriaList];
	}
...
- (UMGSMMAP_D_CSI *) processAfterDecodeWithContext:(id)context
{
	int p=0;
	UMASN1Object *o = [self getObjectAtPosition:p++];
	if((o) && (o.asn1_tag.tagNumber == 0) && (o.asn1_tag.tagClass == UMASN1Class_ContextSpecific))
	{
		dp_AnalysedInfoCriteriaList = [[UMGSMMAP_DP_AnalysedInfoCriteriaList alloc]initWithASN1Object:o context:context];
...
- (id) objectValue
{
	...
	if(dp_AnalysedInfoCriteriaList)
	{
		dict[@"dp-AnalysedInfoCriteriaList"] = dp_AnalysedInfoCriteriaList.objectValue;
	}
	if(camelCapabilityHandling)
	{
