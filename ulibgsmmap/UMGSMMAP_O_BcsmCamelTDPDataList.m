...
- (UMGSMMAP_O_BcsmCamelTDPDataList *) processAfterDecodeWithContext:(id)context
{
	...
	while(o)
	{
        UMGSMMAP_O_BcsmCamelTDPData *e = [[UMGSMMAP_O_BcsmCamelTDPData alloc]initWithASN1Object:o context:context];
...
- (id) objectValue
{
    ...
    for(UMGSMMAP_O_BcsmCamelTDPData *e in _sequenceEntries)
    {
