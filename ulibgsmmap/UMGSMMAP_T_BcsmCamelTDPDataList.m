...
- (UMGSMMAP_T_BcsmCamelTDPDataList *) processAfterDecodeWithContext:(id)context
{
	...
	while(o)
	{
        UMGSMMAP_T_BcsmCamelTDPData *e = [[UMGSMMAP_T_BcsmCamelTDPData alloc]initWithASN1Object:o context:context];
...
- (id) objectValue
{
    ...
    for(UMGSMMAP_T_BcsmCamelTDPData *e in _sequenceEntries)
    {
